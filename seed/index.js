...
module.exports.run = function(){
  ...
  database.Cabs.add(models.Cab.new({id: 2,type: "XL",model: "Swift",number: "UP151",driver: models.Driver.new({id: 2,name: "Amar",rating: 5,phone_no: "88129328438"}),location: models.Location.new({lat: 4,lon: 2})}));
